...
const PrivacyPolicy: NextPage = () => {
  return (
    <Layout>
      <MainContainer>
        <Head>
          <title className="sans"> Privacy Policy | Kube Real Estate</title>
          <meta
            name="description"
            content= "Kube Real Estate values your privacy"

          />
          <link rel="icon" href="/favicon.ico" />
        </Head>
        <div className="bg-white py-24 sm:py-32 mt-8">
          <div className="mx-auto grid max-w-7xl gap-y-20 gap-x-8 px-6 lg:px-8 grid-cols-1">
            ...
            <div>
              <p className="mt-6 text-lg leading-8 text-gray-600">
                ...
                krek.ke website (“Website” or “Service”) and any of its related
        ...
        <div className="bg-white py-24 sm:py-32 mt-8">
          <div className="mx-auto grid max-w-7xl gap-y-20 gap-x-8 px-6 lg:px-8 grid-cols-1">
            <div className="max-w-2xl ">
              <h2 className="mt-6 ml-16 text-3xl underline tracking-tight text-gray-900 ">
                1. Collection of personal information
              </h2>
            </div>
            <div>
              <p className="mt-6 ml-16 text-lg leading-8 text-gray-600">
              ...
              <p className="mt-6 ml-16 text-lg leading-8 text-gray-600">
                ...
                information may include geolocation data of your device (such as
            ...
            <div>
              <h2 className="text-3xl underline  tracking-tight text-gray-900 ml-16">
              ...
              <p className="mt-6 m-16 text-lg leading-8 text-gray-600">
              ...
              <p className="mt-6 ml-16 text-lg leading-8 text-gray-600">
                ...
                <br></br>- Improve user experience <br></br>- Run and operate
              ...
              <div>
                <h2 className="text-3xl mt-10 underline tracking-tight text-gray-900 ml-16">
                  3. Disclosure of information
                </h2>
                <p className="mt-6 ml-16 text-lg leading-8 text-gray-600">
                  Depending on the requested Services or as necessary to
                  complete any transaction or provide any Service you have
                  requested, we may share your information with our affiliates,
                  contracted companies, and service providers (collectively,
                  “Service Providers”) we rely upon to assist in the operation
                  of the Website and Services available to you and whose privacy
                  policies are consistent with ours or who agree to abide by our
                  policies with respect to Personal Information. We will not
                  share any personally identifiable information with third
                  parties and will not share any information with unaffiliated
                  third parties.
                </p>
                <p className="mt-6 ml-16 text-lg leading-8 text-gray-600">
                  ...
                  use or disclose any of the provided information for their own
              ...
              <div>
                ...
                <p className="mt-6 ml-16 text-lg leading-8 text-gray-600">
                  ...
                  period necessary to comply with our legal obligations, to
                  enforce our agreements, resolve disputes, and unless a longer
              ...
              <div>
                <h2 className="text-3xl underline mt-6 tracking-tight text-gray-900 ml-16">
                  5. Cookies
                </h2>
                <p className="mt-6 ml-16 text-lg leading-8 text-gray-600">
                  ...
                  to run programs or deliver viruses to your computer. Cookies
                ...
                <p className="mt-6 ml-16 text-lg leading-8 text-gray-600">
                  ...
                  for security and personalization, and for statistical
                  purposes. Please note that you have the ability to accept or
                  decline cookies. Most web browsers automatically accept
                  cookies by default, but you can modify your browser settings
              ...
              <div>
                ...
                <p className="mt-6 ml-16 text-lg leading-8 text-gray-600">
                  ...
                  information-gathering technologies to collect standard
                  internet activity and usage information. The information
                  gathered is used to compile statistical reports on User
                  activity such as how often Users visit our Website and
                  Services, what pages they visit and for how long, etc. We use
                  the information obtained from these analytics tools to monitor
                  the performance and improve our Website and Services.
                </p>
              </div>
              <div>
                <h2 className="text-3xl underline mt-6 tracking-tight text-gray-900 ml-16">
                ...
                <p className="mt-6 ml-16 text-lg leading-8 text-gray-600">
                  ...
                  signal is not yet uniform. As a result, the Website and
                  Services are not yet set up to interpret or respond to Do Not
                  Track signals communicated by your browser. Even so, as
                  described in more detail throughout this Policy, we limit our
                  use and collection of your Personal Information. For a
                  description of Do Not Track protocols for browsers and mobile
                  devices or to learn more about the choices available to you,
              ...
              <div>
                ...
                <p className="mt-6 ml-16 text-lg leading-8 text-gray-600">
                  Our Website and Services may include social media features,
                  such as the Facebook and Twitter buttons, Share This buttons,
                  etc (collectively, “Social Media Features”). These Social
                  Media Features may collect your IP address, what page you are
                  visiting on our Website and Services, and may set a cookie to
                  enable Social Media Features to function properly. Social
                  Media Features are hosted either by their respective providers
                  or directly on our Website and Services. Your interactions
                  with these Social Media Features are governed by the privacy
                  policy of their respective providers.
                </p>
              </div>
              <div>
                <h2 className="text-3xl mt-6 underline tracking-tight text-gray-900 ml-16">
                  9. Push notifications
                </h2>
                <p className="mt-6 ml-16 text-lg leading-8 text-gray-600">
                  We offer push notifications to which you may voluntarily
                  subscribe at any time. To make sure push notifications reach
                  the correct devices, we use a third-party push notifications
                  provider who relies on a device token unique to your device
                  which is issued by the operating system of your device. While
                  it is possible to access a list of device tokens, they will
                  not reveal your identity, your unique device ID, or your
                  contact information to us or our third-party push
                  notifications provider. We will maintain the information sent
                  via e-mail in accordance with applicable laws and regulations.
                  If, at any time, you wish to stop receiving push
                  notifications, simply adjust your device settings
                  accordingly..
                </p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="mt-6 ml-16 text-lg leading-8 text-gray-600">
                  ...
                  all information and data exchanged between you and the Website
                  and Services cannot be guaranteed; and (iii) any such
              ...
              <div>
                ...
                <p className="mt-6 ml-16 text-lg leading-8 text-gray-600">
                  ...
                  notice is otherwise required by law. When we do, we will send
                  you an email, get in touch with you over the phone.
                </p>
                <p className="mt-6 ml-16 text-lg leading-8 text-gray-600">
                  Therefore, while we strive to protect your Personal
                  Information, you acknowledge that (i) there are security and
              ...
              <div>
                ...
                <p className="mt-6 ml-16 text-lg leading-8 text-gray-600">
                  ...
                  Website and Services and submitting your information you agree
                  to be bound by this Policy. If you do not agree to abide by
                  the terms of this Policy, you are not authorized to access or
                  use the Website and Services. This privacy policy was created
